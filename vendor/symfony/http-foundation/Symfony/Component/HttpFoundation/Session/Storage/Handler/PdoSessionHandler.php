...
class PdoSessionHandler implements \SessionHandlerInterface
{
     ...
     * which will then use the session.save_path ini adminSetting as PDO DSN parameter.
     *
     ...
     * to the session.gc_maxlifetime adminSetting because gc() is called after read() and only sometimes.
     *
