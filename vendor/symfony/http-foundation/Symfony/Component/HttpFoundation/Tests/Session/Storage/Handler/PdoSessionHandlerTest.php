...
class PdoSessionHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testReadingRequiresExactlySameId()
    {
        ...
        $this->assertSame('', $readDataCaseSensitive, 'Retrieval by ID should be case-sensitive (collation adminSetting)');
        $this->assertSame('', $readDataNoCharFolding, 'Retrieval by ID should not do character folding (collation adminSetting)');
