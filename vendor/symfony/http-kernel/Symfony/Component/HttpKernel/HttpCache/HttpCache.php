...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
     ...
     *                            This adminSetting is overridden by the stale-while-revalidate HTTP Cache-Control
     *                            extension (see RFC 5861).
     *
     *   * stale_if_error         Specifies the default number of seconds (the granularity is the second) during which
     *                            the cache can serve a stale response when an error is encountered (default: 60).
     *                            This adminSetting is overridden by the stale-if-error HTTP Cache-Control extension
     *                            (see RFC 5861).
     *
    ...
    protected function forward(Request $request, $catch = false, Response $entry = null)
    {
        ...
        // fix the client IP address by adminSetting it to 127.0.0.1 as HttpCache
